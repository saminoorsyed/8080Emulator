...
int Disassemble8080Op(unsigned char *codebuffer, int pc)
{
    ...
    case 0xC1:
        ...
        break;
    case 0xC2:
        printf("JNZ     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xC3:
        printf("JMP     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xC4:
        printf("CNZ     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xC5:
        printf("PUSH    B");
    ...
    case 0xC9:
        ...
        break;
    case 0xCA:
        printf("JZ      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xCB:
        printf("JMP     adr,    0x%02x%02x", code[2], code[1]);
        ...
        break;
    case 0xCC:
        printf("CZ      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xCD:
        printf("CALL    adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xCE:
        printf("ACI     data,   0x%02x", code[1]);
        opBytes = 2;
        break;
    case 0xCF:
        printf("RST     1");
    ...
    case 0xD1:
        ...
        break;
    case 0xD2:
        printf("JNC     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xD3:
        printf("OUT     data,   0x%02x", code[1]);
        opBytes = 2;
        break;
    case 0xD4:
        printf("CNC     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xD5:
        printf("PUSH    D");
    ...
    case 0xD9:
        ...
        break;
    case 0xDA:
        printf("JC      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xDB:
        printf("IN      data,   0x%02x", code[1]);
        opBytes = 2;
        break;
    case 0xDC:
        printf("CC      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xDD:
        printf("CALL    adr,    0x%02x%02x", code[2], code[1]);
    ...
    case 0xE1:
        ...
        break;
    case 0xE2:
        printf("JPO     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xE3:
        printf("XTHL");
        break;
    case 0xE4:
        printf("CPO     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xE5:
        printf("PUSH    H");
    ...
    case 0xE9:
        ...
        break;
    case 0xEA:
        printf("JPE     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xEB:
        printf("XCHG");
        break;
    case 0xEC:
        printf("CPE     adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xED:
        printf("CALL    adr,    0x%02x%02x", code[2], code[1]);
    ...
    case 0xF1:
        ...
        break;
    case 0xF2:
        printf("JP      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xF3:
        printf("DI");
        break;
    case 0xF4:
        printf("CP      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xF5:
        printf("PUSH    PSW");
    ...
    case 0xF9:
        ...
        break;
    case 0xFA:
        printf("JM      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xFB:
        printf("EI");
        break;
    case 0xFC:
        printf("CM      adr,    0x%02x%02x", code[2], code[1]);
        opBytes = 3;
        break;
    case 0xFD:
        printf("CALL    adr,    0x%02x%02x", code[2], code[1]);
